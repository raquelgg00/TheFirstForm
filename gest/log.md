...
# HITO 0
## 20210227 raquelgg00 @(1h)
Completar gdd, investigar como crear subproyectos, ramas y compilar.
## 20210227 GaspiMr6 @(3h)
Prototipo terminado: Movimiento del personaje y final del nivel (falta revisión).
## 20210228 diegovb7 @(2h)
Aprender a crear ramas y compilar, pasar todos los prototipos a git e investigación de merge entre ramas.
## 20210228 Lauriscus20 @(5h)
Ver videos, aprender a compilar y ver cómo hacer el salto del personaje.
## 20210301 diegovb7 @(1h)
Prototipo terminado: Colision con suelo y paredes (falta revisión). 

## 20210301 VanessaDP @(1h)
Investigar como funciona el sfml.

## 20210301 VanessaDP @(5h)
Modulo de coger arista y evolucionar terminado. He tardado tanto porque he estado dos de esas horas investigando como hacer de la mejor manera la coisión. De momento la he dejado en cuando tienen la misma posición y he hecho commit por no tardar más, en estos días lo actualizaré con la nueva forma.
## 20210301 diegovb7 @(5h)
Colisión con suelo y paredes perfeccionado, prototipo terminado: plataformas móviles automáticas y plataformas móviles cuando estas encima y metodos de almacenamiento de paredes, tanto estáticas como dinámicas
## 20210301 VanessaDP @(6:15h)
Modulo de coger arista y evolucionar terminado. Colisión con getGlobalBounds() y desaparece moneda.
## 20210301 GaspiMr6 @(3h)
Prototipo terminado: Enemigo te ve a distancia y empieza su movimiento (falta revisión)
## 20210301 raquelgg00 @(2h)
Investigando Tinyxml (da errores de codigo)
## 20210301 gnm5 @(3h)
Busqueda de informacion sobre SFML
## 20210301 gnm5 @(30min)
Prototipo hecho: encogerse
## 20210301 raquelgg00 @(1.5h)
Prototipo empujar empezado. Al colisionar con el objeto se puede mover. (falta mejorar funcionalidad)
## 20210301 Lauriscus20 @(4h)
Mejorar salto e investigar cómo hacer el salto con efecto mientras caminas
## 20210303 Lauriscus20 @(30min)
Prototipo:Salto conseguido
## 20210303 raquelgg00 @(3h)
Se ha incluido Tinyxml2 y la lectura de fichero esta a medias para el mapa.
## 20210303 raquelgg00 @(15min)
Prototipo terminado: Empujar (falta revisión)
## 20210304 gnm5 @(2h)
Prototipo terminado: acercarse a un npc y que este te hable(falta mejorar)
## 20210305 raquelgg00 @(4h)
El mapa ya lee y almacena correctamente el contenido del tmx, falta mostrarlo.
## 20210305 GaspiMr6 @(4h)
Prototipo en curso: Rebote. Funciona con gravedad y un reloj
## 20210306 Lauriscus20 @(2h)
Conseguir hacer pull correctamente. Prototipo de reinicio de nivel hecho
## 20210307 Lauriscus20 @(4h)
Prototipo del mundo 2 empezado y acabado.
## 20210307 VanessaDP @(11h)
Prototipo de bola en plano inclinado empezado, he tratado de incluir varias librerias y ninguna me ha funcionado. No he conseguido adaptar la colision a la forma del objeto. Sin terminar, en proceso.
## 20210307 GaspiMr6 @(2.5h)
Prototipo del rebote acabado. He implementado 2 formas. Una con un reloj para la implementación de la gravedad
y la otra sin reloj (en esta última he añadido tanto rebote vertical como horizontal).
## 20210307 raquelgg00 @(4h)
Codigo de cargar mapa realizado. Salta errores de segmentation fault.
## 20210308 raquelgg00 @(4h)
Prototipo cargar mapa casi terminado. Falta cargar png transparentes (los carga mal).
## 20210308 raquelgg00 @(30min)
Prototipo cargar mapa terminado.
## 20210308 GaspiMr6 @(3h)
Prototipo opcional del cañón casi hecho. Dispara cuando entras dentro de su rango de accion.
## 20210308 diegovb7 @(1h)
Empezar prototipo molino y a la espera de solucionar el problema de que se queda colgado.
## 20210308 VanessaDP @(3h)
Prototipo terminado de bola cayendo por plano inclinado
## 20210309 VanessaDP @(1h)
Prototipo empezado y terminado de habilidad romper
## 20210309 GaspiMr6 @(2h)
Prototipo opcional del cañón terminado. He hecho algunas mejoras y corregido errores. He añadido un giro máximo del cañon, un segundo radio de accion (con el primer radio se gira para apuntar y con el segundo empieza a disparar).
## 20210310 raquelgg00 @(15min)
Prototipo de menu empezado. Falta añadir sonidos.
## 20210310 gnm5 @(2h)
Busqueda de informacion sobre como hacer para que la camara siga al personaje
## 20210310 raquelgg00 @(4h)
...
## 20210322 Vanessa Davó Parreño @(2h 30min)
...
## 20210324 raquelgg00 y GaspiMr6 @(20min)
...
## 20210408 GaspiMr6, raquelgg00@(4h)
...
Además, hemos añadido varios !=NULL que faltaban y revisado todo el codigo por si acaso.
...
## 20210415 GaspiMr6 y raquelgg00 @(3h)
